...
# 1 "./Modules/RealTimeClockDS1307/../Uart_LoggingDate/UART_LoggingDate.h" 1
# 15 "./Modules/RealTimeClockDS1307/../Uart_LoggingDate/UART_LoggingDate.h"
void UART_LOGGINGDATA_send_string(uint8_t *string, uint8_t string_length);
# 15 "./Modules/RealTimeClockDS1307/RealTimeClockDS1307.h" 2
...
# 16 "./Modules/EEPROM_24C02C/EEPROM_24C02C.h"
...
# 16 "./Modules/TemSensor_TC74/TemSensor_TC74.h"
uint8_t TEMSENSOR_TC74_Read_Temp(i2c_address_t TC74_Address);
# 47 "main.c" 2


RTCDS1307_t RealTimeClockDS1307;
uint8_t valueu3 = 0;
uint8_t valueu5 = 0;
uint8_t Temp_A7_Value;
...
void main(void)
{
    ...
    UART_LOGGINGDATA_send_string("Start\r", 6);
    EEPROM_240C02C_Write_Byte(0xA6, 0x10, 0xDD);
    valueu5 = EEPROM_240C02C_Read_Byte(0xA6, 0x10);
    while (1)
    {
        ...
        Temp_A7_Value = TEMSENSOR_TC74_Read_Temp(0x9E);
        I2C_Write1ByteRegister(0x70, 0x00, Temp_A7_Value);
